#!/usr/bin/env python3
"""
Test Expense API with 2000+ Records
"""
...
def main():
    ...
    try:
        ...
        for size in test_sizes:
            ...
            response = requests.get(f'http://localhost:5001/api/finance/expenses?limit={size}')
            end_time = time.time()
        ...
        print('✅ Expense API endpoints working successfully')
